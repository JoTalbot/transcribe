...
Текущий документ обновлён после проверки `main`; последний зафиксированный функциональный commit перед документационными обновлениями: `fdc01f0f8ce6294e12fc3cdd7dcfad5542963d07`.
...
Документационные commits после этого требуют обычной повторной CI-проверки. CI не выполняет реальный GPU inference в Google Colab и поэтому не может закрыть physical E2E gate.
